...
status: established
date: 2026-09-09
topic: Samuel terminal separation, finite resources, processing, full exposure
authority: explicit author decision
---

# Samuel Terminal Separation and Self-Destruction Ending

## Author decision

At the end of the process, Samuel is formally separated from Sylvan.

Samuel receives **$15 million** to attempt to execute his plan himself. He is no longer attached to Sylvan and loses access to every process-provided system he had been using to attack Sylvan.
...
- the earlier **$1.5 million** figure;
- any interpretation in which Samuel continues attacking Sylvan through the same process-provided systems during the separated phase;
- any additional equalized continuation phase after the money is exhausted;
- any separate rule violation, discretionary review, or later trigger between financial exhaustion and processing.
