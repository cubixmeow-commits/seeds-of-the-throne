...
- [ ] The hidden hierarchy becomes legible without merging Sylvan, the Resistance, Konrad, or the affected groups into one organization.
- [ ] Every decisive claim has an evidence owner, authenticator, audience, and action.
- [ ] Samuel Jr. and the descendants retain personhood and independent agency.
- [ ] Konrad's commitment changes the operational state before Samuel is processed.
