...
Start system work with:

- [[08 Story Loop/DEVELOPMENT-ORCHESTRATOR]]
- [[08 Story Loop/GAP-ANALYZER]]
...
Finished-novel prose is not the default at this stage. Use short non-canon development prototypes to test ideas. General high-level *Expeditionary Force*-associated principles may guide clarity, objectives, problem-solving, conversational exposition, competence, escalation, and audiobook legibility; do not imitate Craig Alanson's exact prose or distinctive expression.
...
- Konrad believed the colonization rules allowed successful conquest to expand his jurisdiction until he controlled the entire planet and effectively made his own rules.
...
- automatic versus later control powers;
