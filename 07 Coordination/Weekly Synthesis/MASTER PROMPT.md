...
1. state what changed and what the story currently appears to be;
2. reconstruct the current story from beginning to ending, showing gaps rather than filling them;
3. audit major character motives, knowledge, agency, trajectory, missing transitions, strongest material, and weak logic;
4. attack chronology, causality, conveniences, system permissions, knowledge leaks, status drift, and evidence gaps;
5. rank the 10–20 questions with the greatest downstream value;
6. mine scenes already implied by current material, including confrontations, discoveries, reversals, betrayals, transitions, and evidence reveals;
7. map revelations to required setup, artifacts, surveillance, genealogy, records, behavioral fingerprints, authentication, custody, and payoff;
8. build a dependency-ordered next-week queue labeled BUILD NOW, BRAINSTORM NEXT, or LEAVE OPEN;
9. extract spoiler-aware public-development ideas without presenting proposals as canon;
10. recommend vault maintenance, but do not mutate or promote material during the analysis run.
