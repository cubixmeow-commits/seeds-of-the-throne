...
Chronology asks what causes what. Revelation order asks what a reader knows, suspects, and misunderstands at a particular moment. They need separate maps.

The broad order is established. Exact dates, overlapping durations, the placement of the Disclosure Wars, and several ages remain working questions. The leaders' thousands-year program should not be squeezed into the much shorter Samuel–Konrad conflict.

## Spoilers: chronological sequence
...
4. The primary leaders offer Konrad's group permanent control of the largest empire if it teams with Samuel and takes Sylvan before Sylvan's forty-second birthday. Neither the planet nor the overall process is offered.
5. Samuel lies about what Sylvan and the successor Luminai really are. Konrad stays because the lie makes the imperial bait appear achievable through his experienced Daemon and older model of domination.
6. Samuel performs vulnerability, offers false autonomy, and lets Konrad's Daemon verify the appearance. Konrad authorizes reactivation inside Samuel's actual structure.
7. Samuel captures institutions, succession, interpretation, and generations of the group. Konrad eventually occupies an isolated fantasy of future victory.
8. Samuel, Konrad, and the older contained generation remain on the previous planet. George participates directly on the newer planet where Sylvan and Orzai meet, resist manufactured distrust, and develop their Luminai bonds.
9. Sylvan and Orzai preserve resources, independent cooperation, and reality-and-ethical anchoring while completing separate Luminai bonds.
...
| Reader experience | What it accomplishes | What remains to choose |
| --- | --- | --- |
| Book One: present claims begin to fail. | Establish a live psychological mystery. | Viewpoint, first anomaly, and visible stakes. |
| Book One: the circle recognizes a repeated method. | Connect current action to buried history. | Which records and people make the inference credible. |
| Book One: outcome presentation. | Demonstrate bounded control and expose command. | Privacy, differentiated accountability, and emotional choreography. |
| Later books: live through the real imperial bait. | Recover agency, relationships, and contingency. | Why the leaders offered it, what Samuel said about Sylvan, and what each person chose. |
