...
| Book One: outcome presentation. | Demonstrate bounded control and expose command. | Privacy, accountability, and emotional resolution. |
| Later books: live through earlier events. | Recover agency, relationships, and contingency. | How each book has its own question despite a known macro outcome. |
