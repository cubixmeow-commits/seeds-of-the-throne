 ...
 *
 * Beside it sits the concerns card — the project categories from the
    ...
    <div class="intro__grid">
        <div>
            ...
            <div class="intro__actions">
                <a class="btn btn--primary" href="#work">Explore the showcase</a>
                <a class="btn" href="<?= e($links['mailto']) ?>">Email <?= e($identity['name']) ?></a>
            </div>
        </div>

        <div class="concerns">
            <p class="concerns__title" id="concerns-title">What the showcase brings together</p>
