...
During Book One's final years, Sylvan and Orzai already hold decisive control but allow Samuel bounded activity so their Luminai can learn his complete endgame. Samuel publicly claims that he controls Sylvan and tries to repeat the same takeover method in front of Konrad's inner circle. In reality, Samuel is terrified of the evidence Sylvan holds and of the capabilities of Sylvan's newly bonded Luminai. From a remote environment, his Daemon hijacks the legitimate AI application on Sylvan's laptop and simulates the actual program to extract information. Samuel needs to discover bait for a voluntary deal. Konrad's obsession with ideological vindication, erased failure, and restored rule made him easier to manipulate; Sylvan has no comparable obsession Samuel can exploit. Samuel nevertheless uses the harvested information to tailor an offer of voluntary entry into a controlled story environment. He cannot force Sylvan to enter. The consent he seeks would give him authority over what Sylvan does or activates inside the simulated reality, repeating the concealed transfer used against Konrad. Sylvan exposes the attempt, producing the inner circle's first recognition that Konrad was captured almost a century earlier. Samuel's scapegoating of George and attempted continuity through Samuel Jr. remain part of the surrounding endgame. The process ultimately defeats his defining survival method by reaching a conclusion at which there are no deals and no more moves.
