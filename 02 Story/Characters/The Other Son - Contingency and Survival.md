...
The other son's parentage is not the only abuse of the breeding program. It is the most strategically important known instance of a wider pattern.
...
## Relationship to the audio archive

George's failure creates the father's crisis because Sylvan can now use the audio files to expose what has been hidden.

The archive threatens more than one individual. Its disclosure can expose the methods by which the contained-criminal hierarchy operated, including manipulation of bloodlines, secret parentage, weaponized descendants, false legitimacy, and cooperation among the contained leadership.

Sylvan does not need to expose the other son's identity or every child's parentage to prove the system. Authenticated record comparisons, private orders, blackmail communications, and anonymized pattern evidence may establish the father's conduct while protecting descendants from being converted into public proof.

The father's contingency strategy therefore emerges from survival pressure: he realizes Sylvan is now likely to expose him and that the resulting disclosure could destroy both his personal authority and the larger hierarchy that protected it.
...
- whether the two heirs cooperate, compete, audit one another, or discover the same hidden pattern independently;
