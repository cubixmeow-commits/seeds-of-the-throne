...
After the Great War, Konrad and Aiden each accept a separate altered reality maintained through Samuel's story influence, apparent autonomous recovery, Fitzgerald systems reactivated inside Samuel's bounded jurisdiction, and their own obsession with prophecy and dominance over rivals. Their accounts can overlap, but they need not receive the same records, roles, or explanations. They believe their group remains separate and that their reactivated initiatives remain under Fitzgerald control.

**Established later separation:** In the Sylvan endgame, Konrad remains physically on the older containment world while Aiden lives on Planet Three alongside George and Sylvan. Each man's separate altered account can persist across that separation; Aiden's transfer date and means are unresolved.
...
**Established deception boundary (2026-09-24):** Samuel also lies to Konrad and maintains a separate altered reality around his apparent restoration and superiority project. Konrad knows the chips were removed and participated in presenting an apparent success, but that knowledge does not imply he knows Samuel's true experimental results, staged mechanisms, capture of the breeding program, or separate promises to George and Aiden. The precise further lie Konrad believes remains unresolved. He can be both complicit in concealing one fact and deceived about the larger program.

**Working timing reconciliation:** Konrad might receive an independently verified breach of the wider breeding program, try to stop a concrete local operation, and disclose removal to Sylvan before Samuel's terminal processing while still not comprehending the complete bloodline outcome. [[02 Story/Timeline/Timeline]] places his full forced confrontation after processing. The earlier actionable-knowledge versus later complete-recognition distinction is a proposed bridge, not established timing. An alternate post-processing disclosure needs an active program he can still stop. What he believes after removal and which record changes that belief are the next author gate; his only endgame aims remain stopping the program and exposing Samuel.
...
Konrad is a true fanatic. Samuel Franklin wants personal glory, revenge, attention, and the appearance of royalty. Konrad genuinely believes that ancestry should determine human value, political authority, reproduction, and civilization's future. He is willing to subordinate himself and his family to that doctrine.

Konrad is approximately **300 years old** at the final showdown with Sylvan. His still-unnamed senior partner is approximately the same age. Konrad is roughly eighty years older than Samuel, placing him in an earlier criminal generation.
...
Samuel's wealthy parents are committed members of the Fitzgerald order. They share its obsession with bloodline purity, hereditary hierarchy, fascist political structure, and the belief that the organization represents a superior civilizational future.
...
## The Great War and world-conquest attempt

The Great War is now rooted primarily in **Konrad's organization**, not in Samuel's later Throne.

Konrad, his senior partner, his family network, Samuel's parents, and the larger purity movement attempt to expand their authoritarian order across the reconstructed world. They convert institutional influence, national power, ideological organization, military force, and dynastic legitimacy into a global-conquest project.
...
Crucially, Samuel Franklin is already there.
...
In reality, Samuel sabotages the organization through those relationships while learning how to operate inside the environment that will later contain them.

Konrad's movement does not lose solely because Samuel betrays it. Its own authoritarian overreach, strategic failures, institutional brittleness, and ideological blindness remain primary causes. Samuel's sabotage acts as an internal accelerant and later source of humiliation.
...
Repeated inbreeding creates hereditary damage or another biological limitation the faction cannot publicly acknowledge. Admitting the problem would threaten Konrad's claim that closure preserves superiority.

Samuel presents himself as the person who can resolve the contradiction.

He claims advanced reproductive and genetic methods can remove harmful inheritance, preserve the certified line, and potentially create the exceptional abilities Konrad believes the family should possess.
...
The attack is now understood as revenge rooted in exile. The organization that cast Samuel out defined itself through bloodline, ancestry, inheritance, and hereditary belonging. Samuel eventually gains control of the machinery that defines those things.

He arranges unauthorized reproductive interventions involving the Fitzgerald line, introduces descendants the faction's doctrine would reject, falsifies genealogies, and uses biological synthetics or staged substitutions to present false children and grandchildren as verified descendants.

Samuel therefore does not merely violate Konrad's breeding program. He turns the program into the mechanism through which the exiled son of loyal members rewrites the organization that rejected him.
...
Much of that continuity is curated by Samuel.

The official family tree combines real descendants, unauthorized descendants, falsified parentage, and synthetic substitutions. Individual deceptions reinforce one another until Konrad mistakes Samuel's controlled display for independent proof that his lineage is flourishing.

Sylvan's eventual reconstruction compares biological evidence, reproductive records, identity provenance, synthetic histories, and successive versions of the genealogy. The official tree then collapses toward the much smaller genuine line.

## Samuel's attempt to become Konrad

Samuel's relationship to Konrad evolves from revenge into attempted replacement.

Konrad possesses everything Samuel was raised to value but ultimately lost: sacred ancestry, followers trained to recognize hierarchy, dynastic legitimacy, breeding authority, historical importance, and permanent seniority.

Samuel first wants to hurt Konrad's order. Then he begins taking over the functions that make Konrad who he is.

He controls the bloodline. He defines which descendants are real. He interprets defeat. He manages access to hidden records. He becomes the person followers increasingly rely upon to understand the world around them.

Samuel is therefore not merely overthrowing Konrad. He is gradually trying to **become the functional patriarch of the organization**.

## Endgame exposure

Sylvan exposes Konrad alongside Samuel.

Konrad can truthfully claim that Samuel deceived him, sabotaged the organization, violated his family, corrupted the breeding program, and attempted to replace him. None of those facts absolve him.

Konrad:

- created the purity doctrine;
- built the breeding program;
- converted his family into political reproductive material;
- led or helped lead the global-conquest project;
- lost the Great War;
- accepted Samuel back into proximity because he wanted Samuel's promises to be true;
- suppressed or ignored evidence threatening the program;
- preserved the hierarchy Samuel eventually captured.
