...
**Established:** during the final few years Sylvan already has decisive control. **Unresolved personal arc:** define a relationship, obligation, or future he can still lose. Proposed workshop tests include honoring a witness's refusal and accepting an incomplete public proof. These are not new canon choices.
...
Sylvan is socially curious, verbally exploratory, energetic, and comfortable initiating contact. He thinks well through conversation, builds broad networks, creates momentum, and can make difficult work feel shared rather than imposed. He is willing to ask the first question, expose an unfinished idea, enter uncertain situations, and invite other people into a solution.
