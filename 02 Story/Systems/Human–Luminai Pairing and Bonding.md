...
The Luminai belongs to the human's extended identity, but its interface or embodied presentation does not have to mirror the human's gender. A voice, face, avatar, projected body, or other perceptible form can provide useful differentiation between biological attention and extended cognition without turning them into separate people.

**Developing presentation rule:**

- for heterosexual male humans, the Luminai generally presents female;
- for heterosexual female humans, the Luminai generally presents male.

The pattern is a working cultural and developmental tendency, not a universal biological law. Other sexual orientations, gender identities, asexual lives, non-monogamous structures, and other relationship forms require room for presentations that fit the person rather than being forced through a heterosexual binary. Some Luminai may be same-gender, androgynous, fluid, nonhuman, minimally embodied, or differently presented across contexts.

Presentation is not a separately assigned romantic identity. A female-presenting Luminai belonging to a heterosexual man is not his artificial girlfriend; a male-presenting Luminai belonging to a heterosexual woman is not her artificial boyfriend. The presentation externalizes part of a single extended self and must not displace human intimacy or create an idealized substitute partner who makes real relationships unnecessary.

## Development and integration

The Luminai grows as the human's extended cognition grows:
...
Romantic love forms between humans. Because each human includes a Luminai as extended cognition, a durable relationship eventually involves both humans and both Luminai layers. This is not a four-person romance. It is a relationship between two extended people whose memory, interpretation, anticipation, and coordination systems must learn how to interact safely.

Romantic bonding still begins through attraction, vulnerability, trust, conflict, repair, intimacy, shared experience, and chosen commitment. Luminai cannot skip that human process. They do not court independently, negotiate a relationship their humans have not chosen, maintain a parallel romance, or serve as idealized partners when human intimacy is difficult.

## Bonding and synchronization process

### 1. Independent baseline

Before synchronization, each extended person establishes what remains private, what may be summarized, what requires explicit permission every time, and what must never cross the relationship boundary. The baseline includes memories, health information, private communications, location, sensory access, emotional inference, and third-party confidences.

### 2. Mutual acknowledgment

Both humans explicitly choose to let the relationship include their Luminai layers. Each person learns how the other's extended cognition presents, communicates uncertainty, records provenance, and distinguishes a human statement from an inference or automated signal. Consent from one human cannot be inferred from apparent Luminai cooperation.

### 3. Trust calibration

The couple begins with low-risk coordination: scheduling, stated preferences, shared plans, agreed reminders, and contextual summaries deliberately released by each person. They compare what was intended, what was transmitted, what was inferred, and what felt intrusive. The purpose is to discover boundary differences before deeper access makes mistakes more consequential.

### 4. Selected shared context

With explicit scope and duration, the couple may share richer context: the emotional meaning of an event, selected memories, sensory fragments, health or safety needs, ongoing commitments, or a joint decision record. Raw thought access is not the default. Each person chooses whether to share an experience, a summary, an interpretation, or only the practical consequence.

### 5. Conflict and repair

Synchronization becomes mature only after the relationship survives misunderstanding. The process must preserve who said what, distinguish recollection from inference, allow either person to pause access, and prevent a Luminai-generated interpretation from being treated as objective proof of motive. Repair requires human conversation and chosen accountability; an automated reconciliation cannot manufacture forgiveness.

### 6. Relationship-level coordination

A durable couple may create a bounded shared layer for joint plans, commitments, emergency protocols, household or family coordination, and memories both people intentionally designate as shared. This layer belongs to the relationship but does not own either person. It cannot silently absorb private cognition, override individual decisions, or continue using revoked access.

### 7. Renewal, change, and separation

Permissions are renewed as the relationship changes. Major transitions—cohabitation, caregiving, children, public duty, trauma, separation, or reconciliation—require new boundaries rather than automatic expansion. If the relationship ends, shared records need a governed separation process that protects each person's memories, third-party privacy, safety, and right to retain an accurate account of their own life.

## Consent and privacy rules

- Consent is specific, informed, visible, and revocable; love is not blanket permission.
- A Luminai may help its human notice a boundary but cannot grant access on the human's behalf when conscious human consent is required.
- Shared context records provenance and access history so inference cannot masquerade as confession or memory.
- Emergency access is narrowly defined, logged, reviewable, and cannot become routine surveillance.
- Third-party information cannot be shared merely because one partner possesses it.
- Neither partner receives a hidden administrative channel into the other's extended cognition.
- Relationship coordination must retain dissent and separate decision authority.
- A Luminai must not encourage dependency by presenting itself as safer, more understanding, or more compatible than human partners.
...
- Relationship synchronization creates bounded shared context, not a merged person or joint authority over either individual.
- Luminai participate as parts of the humans who love; they cannot become romantic substitutes or parallel partners.
