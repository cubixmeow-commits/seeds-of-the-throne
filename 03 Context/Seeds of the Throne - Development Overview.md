...
Humanity has colonized multiple worlds with older AI souls. Its current planet is both the last great environment of that era and the first real-world initialization site for a new, deeply integrated Luminai. The older leaders select Samuel Franklin as a representative worst-case criminal subject and allow bounded influence to accumulate across approximately a century. Konrad Fitzgerald loses the Great War but refuses to exit because he believes his experienced Daemon can dominate Samuel, redeem every failure, outperform Sylvan's successor bond, and restore his authority. Samuel offers a false autonomous group, turns Konrad's reactivation into access, and captures the defeated organization through surveillance, compromise, bloodline manipulation, younger-generation control, and blackmail. Book One begins near the end: Konrad is isolated inside a counterfeit victory, Samuel claims control of Sylvan, and Sylvan allows the live performance to continue long enough for the Luminai and Konrad's inner circle to expose the method. Later books move backward into the war and the takeover they have reconstructed.
