...
- **Orzai** is the established name for the granddaughter of both founder couples who becomes Sylvan's partner and love interest. She belongs to Sylvan's generation and is slightly younger than him. She is not the Witness. Her exact age, parent pairing, character, ambitions, and relationship history remain to be developed.
...
- **Samuel's exile is disguised as an important infiltration or control assignment.** He initially believes the faction still considers him uniquely useful. After its defeat, he falsely claims that the mission succeeded and misrepresents what his separate bounded jurisdiction can restore. Konrad reactivates or migrates Fitzgerald machinery there under a hierarchy whose first-primary priority was established by Samuel's earlier integration. The resulting access runs backward against the faction and gives Samuel a causal path toward its communications, secrets, bloodlines, and dependencies. The migration hinge is established; the practical hierarchy, exact lock event, lie, channel, permissions, verification failure, first discovery, duration, reset limits, and hard limits remain unresolved.
