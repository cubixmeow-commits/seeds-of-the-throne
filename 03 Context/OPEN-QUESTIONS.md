...
Current unresolved work is organized adaptively in [[07 Coordination/Story Completion Workflow/Reassessment Workshop/README]]. RW-01 through RW-07 are author-accepted. The highest remaining dependency is the three capacities learned during the reserve and employment stages that directly enable terminal survival. Later modules address institutional accountability and the reverse-series handoff.
...
- What customized bargain does Samuel offer Sylvan after scapegoating George, what route does he expect Samuel Jr. to preserve, and why does Sylvan refuse?
- What can pass between the previous containment planet and Sylvan's newer planet, and what decisions remain independently George's?
...
- How do the Reconciliation, Boundary, Cultivation, and Evidentiary schools share authority?
- What threshold allows one school to stop an environment supported by another?
...
- What can story influence alter: salience, records, institutional reactions, coincidence, or all four under different limits?
- Who authorizes story influence during the Foundational Exposure Era?
- How does the sealed record remain authentic across a century of public revision?
- What threshold ends narrative containment and triggers public comparison of story with reality?
- How are ordinary people protected while contained leaders receive meaningful narrative influence?
...
- What education and first professional home join Orzai's health/nutrition knowledge with creative design, video, and 3D modeling during the 2015–2020-equivalent transition?
- Which visualization does Orzai refuse to simplify or falsify, what does that refusal cost, and which later colonization responsibility grows from it?
