...
2. [ ] **Build Samuel and George's unresolved thirty-year prewar history.** Samuel's failed privileged-heir status, underage relationship, family/organizational exile roughly thirty years before the Great War, Konrad's impossible takeover mission designed to fail, George's authentic apparent success, their private wrongdoing, and George's humiliating bust into containment are established. Define Samuel's age and material losses, why Konrad chooses this form of disposal, how failure is guaranteed, who operationally places them, George's real authority, the private and overt acts they choose, Samuel's containment status and consequences, and what Samuel's parents know. Do not restore the superseded fifty-year rampage by default.
...
8. [ ] **Continue developing Orzai as a person and professional.** Her name, place in Sylvan's generation, slightly younger relative age, emerging-leader training, reserved/introverted temperament, health and nutrition interests, creative design/video/3D-modeling capability, complementary but independent relationship with outgoing Sylvan, and intended role as his partner are established. The working career arc moves from health visualization toward interactive training and population-scale colonization health systems. She is not the Witness. Define her education, first professional home, strongest medium, signature project, specific worldview, upbringing, relationship to her parents' Great War history, contribution to the archive, leadership failure, first meeting with Sylvan, and reason for choosing him.
...
18. [ ] **Build George's prewar apparent-success and bust sequence.** Define his age, public identity, real authority, who operationally places Samuel and George, what the largest government believes, how Konrad guarantees the mission's failure, what Samuel and George choose to do privately and overtly, the humiliating exposure, the containment procedure, Samuel's consequences, and how this phase relates to George's later three public roles.
