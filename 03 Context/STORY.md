...
The Book One endgame now uses a live repetition to unlock the older history. Samuel has kept Konrad and his son Aiden inside a postwar altered reality built from story functionality, false autonomy, reactivated systems, prophecy, and their obsession with defeating rivals. Konrad and Aiden sincerely believe they lead an original holy order placed by divine purpose. Samuel counterfeits the authority that interprets that purpose and assigns Sylvan the next rival role. Sylvan's refusal forces Samuel to revise the sacred story in ways the Resistance and inner circle can compare with the Great War aftermath. The present attack therefore reveals the old capture and explains how Konrad and Aiden's apparent recovery drew other leaders into related realities. The exposure proves Samuel's fraud without claiming that faith itself is false.
