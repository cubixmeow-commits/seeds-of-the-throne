...
- [ ] **Build an endgame setup coverage matrix.**
  - **Live progress:** SC-010 is active at Macro Shape. Accepted setup categories are: startup-collapse demonstration of conscious human decision authority; source discrimination between Luminai information and Daemon deception; cross-bond Luminai coordination through bonded humans; real-time Luminai integration with physical technology; bounded adversarial observation that lets Samuel act inside enforced limits while Sylvan preserves decisive control; and repeated-pattern reconstruction that compares Samuel's live attempt against Sylvan with his postwar takeover of Konrad. Current author gate: **after those categories, what is the next major capability, rule, or information skill the outcome presentation requires?**
