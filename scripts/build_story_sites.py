...
def homepage_editorial(body_html, count, total, endgame_count, endgame_total):
  ...
  <section class="editorial-band editorial-band--system" aria-labelledby="endgame-title">
    <div class="editorial-band__copy reading">
      ...
      <p>Samuel also tries to place Sylvan inside the altered story reality that has trapped Konrad and his son Aiden since the Great War. He defines Sylvan as their next rival, then expects Konrad and Aiden to attack him and pressure him into accepting Samuel's version of events.</p>
  ...
  <section class="editorial-band editorial-band--evidence" aria-labelledby="endgame-workshop-title">
    <div class="editorial-band__copy reading">
      ...
      <p>The Endgame Workshop develops the remaining story questions about the hidden leadership layer, Samuel's altered-reality trap, the bloodline operation, the Resistance's evidence, Konrad's commitment, disclosure to every group, and the final presentation.</p>
