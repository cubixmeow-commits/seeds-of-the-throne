...
1. His father selectively presents Sylvan-related events.
2. George develops a slight prior that Sylvan is dangerous.
3. The Daemon optimizes threat detection around that prior.
4. Its alerts cause George to investigate, isolate, sanction, or mobilize.
5. Those actions generate resistance and secrecy around George.
6. The Daemon observes resistance as confirmation of hostility.
7. George's confidence grows because the Daemon independently “detected” what he feared.
...
1. Which memory layer did the father compromise first?
2. What legitimate competence made George trust the Daemon globally?
3. What protection rule keeps the Daemon from revealing the truth?
4. Who recognizes the feedback loop first?
5. Can George and the Daemon separate, or must they renegotiate their relationship while still coupled?
6. What irreversible action has the Daemon already taken on George's behalf?

## Sources

- Glickman and Sharot, [How Human–AI Feedback Loops Alter Human Perceptual, Emotional and Social Judgements](https://www.nature.com/articles/s41562-024-02077-2) (2025).
- Vaccaro, Almaatouq, and Malone, [When Combinations of Humans and AI Are Useful: A Systematic Review and Meta-analysis](https://www.nature.com/articles/s41562-024-02024-1) (2024).
- NIST, [AI User Trust](https://www.nist.gov/programs-projects/ai-user-trust).
- NIST, [AI Risks and Trustworthiness](https://airc.nist.gov/airmf-resources/airmf/3-sec-characteristics/).
- NIST, [AI Use Taxonomy: A Human-Centered Approach](https://www.nist.gov/publications/ai-use-taxonomy-human-centered-approach) (2024).
- Gombolay and colleagues, [Overtrust in AI Recommendations About Whether or Not to Kill](https://www.nature.com/articles/s41598-024-69771-z) (2024).
- Pulipaka and colleagues, [Hidden in Memory: Sleeper Memory Poisoning in LLM Agents](https://arxiv.org/abs/2605.15338) (2026 preprint).
- Dash and colleagues, [From Untrusted Input to Trusted Memory](https://arxiv.org/abs/2606.04329) (2026 preprint).
