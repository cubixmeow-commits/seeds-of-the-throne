...
# Samuel–Konrad Containment Hierarchy — Needs Analysis

## Status

This mechanism remains **UNRESOLVED IN ITS DETAILS** and should be developed in a dedicated piece-by-piece brainstorming session before the exact implementation is canonized.
...
This establishes the hierarchy's **function and moral danger**.

The accepted mechanism is **layered control**. The alpha directly governs the experienced reality and available decision structure but does not simply overwrite every private belief. Samuel must identify the older generation loyal to Konrad and separate those people from the larger population. Konrad and the old loyalists experience a responsive reality based on whatever they believe they are trying to do, so they perceive progress and believe the organization is functioning normally. Outside their awareness, Samuel slowly corrupts the later generations.

The old leadership's isolation prevents it from serving as a living source of continuity for the younger population. This makes the eighty-year duration, generational corruption, bloodline destruction, and spreading of transgressions causally necessary rather than decorative.

## Question 2 — accepted macro answer

All contained criminals enter the colonization process through prosecution. The deals they make during prosecution determine their placement in containment and can establish different roles, jurisdictions, responsibilities, and authority.

A **primary contained criminal** is not simply the strongest criminal present. Primary status is a negotiated containment status established by the prosecution deal. It gives one criminal structural alpha priority inside the relevant containment environment rather than merely placing that person within it.

When Samuel Franklin was prosecuted, he sold out more people than anyone else and negotiated a deal to become the alpha criminal in containment. Konrad Fitzgerald made a separate deal that genuinely gave him leadership of his group and his own city. Konrad did not know that Samuel had separately negotiated the broader alpha position in the containment structure that would later matter after defeat.

This preserves both facts: Konrad's earlier sovereignty was real, and Samuel's later structural priority was also real within the relevant larger containment environment.
...
**Established prosecution rule:** contained criminals enter colonization through prosecution, and their negotiated deals determine placement and can establish leadership, jurisdiction, responsibility, and authority.
...
**Endgame concealment:** Samuel's exile is secretly part of Samuel's own plan/deal, but this must remain hidden until the endgame reveal.

**Established hierarchy rule:** If a contained criminal is exiled into the relevant containment structure and becomes the first primary contained criminal integrated into that hierarchy, the hierarchy locks around that placement. Later promises, claims, bargains, or apparent restorations do not undo the structural priority created by that first integration.

**Established consequence:** Anything Konrad later reactivates inside that already-locked largest-empire containment structure is operating under the jurisdiction/control structure established by Samuel's earlier integration, regardless of what Samuel promises Konrad about ownership or restoration.

Konrad Fitzgerald does not understand this rule when his defeated group enters that environment.

The long-term consequence of that misunderstanding is catastrophic: by reactivating Fitzgerald machinery inside the largest empire's containment environment, where the hierarchy is already locked around Samuel, Konrad helps place the operational remains of his own organization under Samuel's control. This becomes a major causal mechanism in the group's permanent destruction.
...
- Samuel later discovers the operational truth of Konrad's betrayal and uses it as the foundation of revenge without absolving his own conduct.
...
- Samuel's earlier placement establishes the hierarchy in that environment before Konrad arrives.
- The hierarchy locks with the first primary contained criminal integrated into it.
...
- Because the hierarchy in the largest-empire containment environment was already locked by Samuel's earlier integration, the reactivated machinery was under Samuel's structural control there from the start, regardless of what Samuel told Konrad.
- Konrad does not understand this until the consequences are already in motion.
- Those consequences are a central reason the Fitzgerald group is ultimately destroyed permanently rather than merely defeated in the Great War.
...
Do **not** reveal early that Samuel's exile was part of his own negotiated plan. The contradiction between apparent exile and concealed alpha deal is an intentional endgame mystery until the mechanism is fully developed.
...
29. How does this mechanism preserve bounded power, evidence, permissions, agency, and the larger containment rules?

## Brainstorming method for next session

Use the same piece-by-piece method as prior successful sessions:

**question -> author answer/correction -> restate exact constraint -> generate 2–4 narrow possibilities -> critique causality/character/continuity -> author selects or rejects -> record accepted element -> move to next question**

Do not write a full solution in advance.
...
- Samuel identifies and separates the older-generation people loyal to Konrad from the larger population.
...
- Samuel's destructive campaign follows his discovery of the operational betrayal behind his assignment; he projects his failures onto the group, destroys bloodlines, and spreads transgressions through it.
- All contained criminals enter colonization through prosecution and negotiated deals that determine placement and can establish authority.
...
- Samuel is integrated into the relevant largest-empire containment structure before Konrad and becomes the first primary contained criminal in that hierarchy.
- The containment hierarchy there locks around the first primary contained criminal integrated into it.
- Later arrivals cannot undo that structural priority merely through promises, status claims, or attempted restoration.
- Samuel has his own bounded containment jurisdiction there.
- Konrad is tricked into reactivating/migrating his old organizational machinery inside Samuel's jurisdiction.
- Anything Konrad reactivates there is operating under the already-locked hierarchy and therefore under Samuel's structural control in that environment from the start.
- Samuel lies about this reality in service of revenge and a longer-term plan to replace Konrad.
- Konrad does not understand the hierarchy rule or its consequences when he reactivates his programs.
- The migration hinge quoted above is central.
...
- the precise causal chain from reactivation to permanent group destruction.
